...
<div id="head_wrapper" class="s-isindex-wrap head_wrapper s-title-img ">
    <div id="s_fm" class="s_form">
        <div class="s_form_wrapper" id="s_form_wrapper">
            ...
            <form id="form" method="POST" action="${pageContext.request.contextPath}/product/queryContent" class="fm">
                <input type="text" class="s_ipt" name="content" id="kw" maxlength="100" autocomplete="off">
